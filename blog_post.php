    ...
    <div id="templatemo_header">
        ...
        <div id="header_right">
            ...
            <div id="templatemo_menu">
                ...
                <li><a href="blog_post.php">文章天堂</a></li>
        ...
        <div class="content_box">
            ...
            <div class="post_section">
                ...
                <ul class="sidebar_menu">
                    ...
                    while($result=mysql_fetch_array($article)){
                    ?>
                         <li><a href="blog_post2.php?id=<?php echo $result['id']?>"><?php echo $result['title']?></a>
                             <?php
                    }
                    ?>
       ...
       <div class="content_box_top"></div><div class="content_box">
        	...
        	<div class="comment_tab">
                ...
                <div id="comment_form">
                    ...
                    <form action="doarticle.php" method="post">
                        <div class="form_row">
                            <label>题目</label><br />
